  ...
  return (
    <Card radius="md" p={0} className={classes.card}>
      <Group noWrap className={classes.group} spacing={0}>
        ...
        <Avatar src={null} radius={"50%"} classNames={{root: classes.teacherImage, image:classes.image,placeholder: classes.placeholder,placeholderIcon:classes.placeholderIcon}} alt="no image here" color="#b5b7bc" />
