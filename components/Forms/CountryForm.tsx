        ...
        <Flex gap={"md"} direction={"row"} justify={"center"} align={"flex-start"} w={"100%"}>
          <Flex direction={"column"} justify={"center"} align={"flex-start"} w={"100%"}>
            ...
            <TextInput
              ...
              size="md"
              onChange={(event) => {
                form.setFieldValue("ISO Alpha-2 Code", event.currentTarget.value);
              }}
            />
            <TextInput
              disabled={readonly}
              ...
              size="md"
              onChange={(event) => {
                form.setFieldValue("ISO Alpha-3 Code", event.currentTarget.value);
              }}
            />
          </Flex>
          <Flex direction={"column"} justify={"center"} align={"flex-start"} w={"100%"}>
            ...
            <TextInput
              ...
              size="md"
              onChange={(event) => {
                form.setFieldValue("Currency Short Name", event.currentTarget.value);
              }}
            />
            <TextInput
              disabled={readonly}
              ...
              size="md"
              onChange={(event) => {
                form.setFieldValue("Currency Symbol", event.currentTarget.value);
              }}
            />
          </Flex>
        </Flex>
